...
public class MainTool {
    ...
    private final String RO_HOME = "D://"; //修改文件的路径

    private final String FILE = "a"; //修改文件的主文件名

    private final String BAK_FILE = FILE + "_bak.db"; //修改文件的备份扩展名

    private final String PATCH_FILE = FILE + ".db"; //修改文件的扩展名
