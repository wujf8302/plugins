...
public class MultiThread {
    ...
    public static void main(String args[]) {
        ...
        ThreadUseExtends thread1 = new ThreadUseExtends(); // 下面创建线程实例thread1
        Thread thread2 = new Thread(new ThreadUseRunnable(), "SecondThread"); // 创建thread2时以实现了Runnable接口的THhreadUseRunnable类实例为参数
