...
@Entity
@Table(name="JBPM_PROCESS_INSTANCE_TBL")
public class ProcessInstanceInfo{

    @Id
    @SequenceGenerator(name = "C_SEQ", sequenceName = "S_JBPM_PROCESS_INSTANCE", allocationSize=1)
...
//  private Set<EventType>                    eventTypes         = new HashSet<EventType>();    
    ...
    @JoinTable(name = "JBPM_EVENTTYPES", joinColumns = @JoinColumn(name = "InstanceId"))
