...
@Entity
@Table(name="JBPM_REASSIGNMENT_TBL")
public class Reassignment implements Externalizable {
    ...
    @ManyToMany
    @JoinTable(name = "JBPM_REASMT_potentialOwners", joinColumns = @JoinColumn(name = "task_id"), inverseJoinColumns = @JoinColumn(name = "entity_id"))    
