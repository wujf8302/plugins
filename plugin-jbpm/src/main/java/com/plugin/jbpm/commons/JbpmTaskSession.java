...
public class JbpmTaskSession extends TaskServiceSession {
    ...
    public JbpmTaskSession(TaskService service, EntityManager em) {
        super(service, em);
    }
    ...
    public void addTask(final Task task, final ContentData contentData)
        ...
        humanTaskEventService.postEvent(HumanTaskEvents.ON_CREATED, task, params);
    }
    ...
    public void taskOperation(final Operation operation, final long taskId,
        ...
        switch (operation) {
            case Complete: {
                humanTaskEventService.postEvent(HumanTaskEvents.ON_COMPLETE,task, params);
                break;
            }
        }
    ...
    public void setHumanTaskService(HumanTaskEventService humanTaskService) {
        this.humanTaskEventService = humanTaskService;
    }
    
    public HumanTaskEventService getHumanTaskService() {
